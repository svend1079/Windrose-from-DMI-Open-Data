...
def vindrose16(datetime_start, datetime_end, idnr, api_key, data_type,file_direction,months):
    ...
    conditions = [
        (vindrose['direction'] <= 11.25),
        (vindrose['direction'] > 11.25) & (vindrose['direction'] <=33.75),
        (vindrose['direction'] > 33.75) & (vindrose['direction'] <=56.25),
        (vindrose['direction'] > 56.25) & (vindrose['direction'] <=78.75),
        (vindrose['direction'] > 78.75) & (vindrose['direction'] <=101.25),
        (vindrose['direction'] > 101.25) & (vindrose['direction'] <=123.75),
        (vindrose['direction'] > 123.75) & (vindrose['direction'] <=146.25),
        (vindrose['direction'] > 146.25) & (vindrose['direction'] <=168.75),
        (vindrose['direction'] > 168.75) & (vindrose['direction'] <=191.25),
        (vindrose['direction'] > 191.25) & (vindrose['direction'] <=213.75),
        (vindrose['direction'] > 213.75) & (vindrose['direction'] <=236.25),
        (vindrose['direction'] > 236.25) & (vindrose['direction'] <=258.75),
        (vindrose['direction'] > 258.75) & (vindrose['direction'] <=281.25),
        (vindrose['direction'] > 281.25) & (vindrose['direction'] <=303.75),
        (vindrose['direction'] > 303.75) & (vindrose['direction'] <=326.25),
        (vindrose['direction'] > 326.25) & (vindrose['direction'] <=348.75),
        (vindrose['direction'] > 348.75) & (vindrose['direction'] <=360)]
    value_degree = [360,22.5,45,67.5,90,112.5,135,157.5,180,202.5,225,247.5,270,292.5,315,337.5,360]
    values_corner = ['N','NNE','NE','ENE','E','ESE','SE','SSE','S','SSW','SW','WSW','W','WNW','NW','NNW','N']
    ...
    over11 = [(len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==360)])) / sum(vindrose['Retning2'].value_counts()) * 100,
            (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==22.5)])) / sum(vindrose['Retning2'].value_counts()) * 100,
              (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==45)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==67.5)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==90)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==112.5)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==135)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==157.5)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==180)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==202.5)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==225)])) / sum(vindrose['Retning2'].value_counts()) * 100,
             (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==247.5)])) / sum(vindrose['Retning2'].value_counts()) * 100,
              (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==270)])) / sum(vindrose['Retning2'].value_counts()) * 100,
              (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==292.5)])) / sum(vindrose['Retning2'].value_counts()) * 100,
              (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==315)])) / sum(vindrose['Retning2'].value_counts()) * 100,
              (len(vindrose.loc[(vindrose['Vindhastighed'] >= 11) &  (vindrose['Retning2']==337.5)])) / sum(vindrose['Retning2'].value_counts()) * 100]
    ...
    m8og11 = [len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==360)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==22.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==67.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==112.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==157.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==202.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==247.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==292.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 11) & (vindrose['Vindhastighed'] >= 8) & (vindrose['Retning2']==337.5)]) / sum(vindrose['Retning2'].value_counts()) * 100]
    ...
    m6og8 = [len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==360)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==22.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==67.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==112.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==157.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==202.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==247.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==292.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 8) & (vindrose['Vindhastighed'] >= 6) & (vindrose['Retning2']==337.5)]) / sum(vindrose['Retning2'].value_counts()) * 100]
    ...
    m4og6 = [len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==360)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==22.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==67.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==112.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==157.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==202.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==247.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==292.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 6) & (vindrose['Vindhastighed'] >= 4) & (vindrose['Retning2']==337.5)]) / sum(vindrose['Retning2'].value_counts()) * 100]
    ...
    m0og4 = [len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==360)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==22.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==67.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==112.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==157.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==202.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==247.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==292.5)]) / sum(vindrose['Retning2'].value_counts()) * 100,
              ...
              len(vindrose.loc[(vindrose['Vindhastighed'] < 4) & (vindrose['Vindhastighed'] >= 0) & (vindrose['Retning2']==337.5)]) / sum(vindrose['Retning2'].value_counts()) * 100]
    # Get name of station
    ...
    fig.update_layout(
        ...
        polar=dict(
            ...
            radialaxis=dict(
                ...
                #tickmode="array",
                tickvals=[3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36],
                ticktext=['3%', '6%', '9%', '12%', '15%', '18%', '21%', '24%', '27%', '30%', '33%', '36%'],
                gridcolor="black",
                showgrid=True,
                showline=False,
                tickangle=45,
            ...
            angularaxis=dict(
                ...
                showgrid=True,
                tickmode="array",
                tickvals=[360,22.5,45,67.5,90,112.5,135,157.5,180,202.5,225,247.5,270,292.5,315,337.5],
    ...
    print(np.round(vindrose, decimals=2))
    print(sum(m0og4) + sum(m4og6) + sum(m6og8) + sum(m8og11) + sum(over11))
    print(len(vindrose.index))
    print(vindrose['Vindhastighed'].sum())
    print(vindrose['direction'].sum())